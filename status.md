...
번역 시작 2026-09-05 · 1일째 · 진행율 0.9% (1/112 단계)

단계: 대기 → 정규화 → 1차 번역 → AI 감수 1 → AI 감수 2 → 사람 감수 → AI 보완 → 확정

| 청크 | 제목 | 원서 쪽 | 분량 | 단계 |
|---|---|---|---|---|
| ch01 | Why Preserve Film? | 1–5 | 5 | 정규화 |
...
| ch05 | Duplication | 41–58 | 18 | 대기 |
| ch06 | Storage | 59–69 | 11 | 대기 |
...
용어집: 전체 162항목 · 확정 34 · 결정 대기 2 · 미착수 126
